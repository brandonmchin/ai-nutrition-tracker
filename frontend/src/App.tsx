            ...
            <div className="flex-1 flex gap-2 w-full sm:w-auto">
              ...
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="h-full px-4 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-r-lg hover:bg-gray-200 dark:hover:bg-gray-600 border border-l-0 border-gray-300 dark:border-gray-600 transition-colors"
